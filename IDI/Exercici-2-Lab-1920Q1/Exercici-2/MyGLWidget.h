...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core
{
  ...
  private:
    ...
    // VAO names
    GLuint VAO_Pil, VAO_Terra, VAO_Arbre, VAO_Patr;
    // Program
    ...
    glm::vec3 centreBaseArbre, centreBasePil, posPilota, centreBasePatr;
    float escalaPil, escalaArbre, escalaPatr;

    glm::vec3 centreEsc, obs, vrp, up;
    float radiEsc, ra, fov, zn, zf, fov2, zn2, zf2;
    bool camera3;
