...
int main() {
    string respuesta, pregunta, respuesta2;
    int puntos = 0;
    
    cout << "Introdueix pregunta: " << endl;
    getline(cin, pregunta);
    cout << "Introdueix resposta: " << endl;
    cin >> respuesta2;
    ...
    cout << pregunta << endl;
    cin >> respuesta;
    if (respuesta == respuesta2) puntos = puntos + 20;
    
    cout << "Puntuaciuó final: " << (puntos/120)*100 << "%" << endl;
